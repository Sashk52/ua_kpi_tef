...
*/
public String [] myInfo={surname,name,middleName,nickname,comment,group,homeTelNumber,mobTelNumber,mobTelNumber2,eMail,skype,index,city,street,buildingNum,flatNum,fullAdrress};


void fullfill(String message){
